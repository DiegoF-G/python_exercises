...
frase_i = frase[::-1]
if frase_i == frase:
    print(f'A frase "{frase}" ao contrário é "{frase_i}". Portanto a frase digitada é um \033[1mpalíndromo\033[m!')
else:
    print(f'A frase "{frase}" ao contrário é "{frase_i}". Portanto a frase digitada \033[1mnão\033[m é um palíndromo.')
