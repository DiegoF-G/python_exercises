...
ap_aluguel = [aluguel[i][1] for i in range(len(aluguel)) if aluguel[i][0] == 'Apartamento']
teste2 = (print('TESTE 2'), print(ap_aluguel), print())

# (3)
meses = ['Jan', 'Fev', 'Mar', 'Abr', 'Mai', 'Jun', 'Jul', 'Ago', 'Set', 'Out', 'Nov', 'Dez']
despesa = [860, 490, 1010, 780, 900, 630, 590, 770, 620, 560, 840, 360]
despesas_ano = {meses[i]: despesa[i] for i in range(12)}
teste3 = (print('TESTE 3'), print(despesas_ano), print())
